...
<thead >
  ...
  <tr>
    ...
    <td style="background-color:#bcbcbc;color:black; font-weight: bold; ">Nos./Month</td><td style="background-color:#b6d4ea;font-size: 14px;font-weight: bold;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${elTarget.targetL5/12}"/></td> <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${elTarget.targetL3/12}"/></td> 
    ...
    <c:choose><c:when test="${(elTarget.targetL3/12)>eLossAvg}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${eLossAvg}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${eLossAvg}</td> </c:otherwise>  </c:choose> 
  </tr>
  <tr>
   ...
   <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${allTarget.targetL5/12}"/></td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${allTarget.targetL3/12}"/></td>
     ...
     <td>${allBreak.breakdownCnt11}</td>
      ...
      <c:choose><c:when test="${(allTarget.targetL3/12)>allBreakTotal}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${allBreakTotal}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${allBreakTotal}</td> </c:otherwise>  </c:choose> 
  </tr>
  <tr>
  ...
  <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${timeTarget.targetL5/12}"/></td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${timeTarget.targetL3/12}"/></td>
     ...
     <td><fmt:formatNumber type = "number" 
      ...
      <c:choose><c:when test="${(timeTarget.targetL3/12)>timeAvg}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${timeAvg}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${timeAvg}</td> </c:otherwise>  </c:choose> 
  ...
  <tr>
    ...
    <td style="background-color:#bcbcbc;color:black; font-weight: bold;">Nos./Month</td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${minorTarget.targetL5/12}"/></td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${minorTarget.targetL3/12}"/></td>
     ...
     <td>${minorStoppages.breakdownCnt11}</td>
      ...
      <c:choose><c:when test="${(minorTarget.targetL3/12)>minorAvg}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${minorAvg}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${minorAvg}</td> </c:otherwise>  </c:choose> 
</tr>
<tr>
...
(Hrs)</td>
  <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${mtbfTarget.targetL5/12}" /></td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${mtbfTarget.targetL3/12}"  /></td>
    <td><c:choose><c:when test="${mtbf.breakdownCnt1>0}"><fmt:formatNumber type = "number" 
     ...
     <td><c:choose><c:when test="${mtbf.breakdownCnt11>0}"><fmt:formatNumber type = "number" 
      ...
      <c:choose><c:when test="${(mtbfTarget.targetL3/12)>mtbfAvg}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${mtbfAvg}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${mtbfAvg}</td> </c:otherwise>  </c:choose> 
</tr>
<tr>
...
(Hrs)</td>
       <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${mttrTarget.targetL5/12}"/></td>
    <td style="background-color:#b6d4ea;font-weight: bold;font-size: 14px;"><fmt:formatNumber type = "number" 
         minFractionDigits = "2"   maxFractionDigits = "2" value = "${mttrTarget.targetL3/12}"/></td>
    <td><c:choose><c:when test="${mtbf.breakdownCnt1>0}"><fmt:formatNumber type = "number" 
     ...
     <td><c:choose><c:when test="${mtbf.breakdownCnt11>0}"><fmt:formatNumber type = "number" 
      ...
      <c:choose><c:when test="${(mttrTarget.targetL3/12)>mttrAvg}"> <td style="font-weight: bold; color:white; background-color:#6bbf2d; font-size:14px;">${mttrAvg}</td> </c:when><c:otherwise> <td style="font-weight: bold; color:white;background-color:#f92018; font-size:14px;">${mttrAvg}</td> </c:otherwise>  </c:choose> 
</tr>
