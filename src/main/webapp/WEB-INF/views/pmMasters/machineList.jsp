			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>PM Machines
							</h3>
							<div class="box-tool">
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search" title="Type in a name" style="border-radius: 23px;">
				...
				<div class="agile-tables">
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tbody>
				              <c:forEach items="${machineList}" var="machineList" varStatus="count">
				               <tr>
				                 <td>${count.index+1}</td>
                              <td>${machineList.machinName}</td>
                              <td>${machineList.machinNo}</td>
                              <td>
                              <c:choose>
                              <c:when test="${machineList.type==1}">
                              Electrical
                              </c:when>
                                <c:when test="${machineList.type==2}">
                              Mechanical
                              </c:when>
                              <c:otherwise>
                              E/M
                               ...
                               <td>
                               <a href="${pageContext.request.contextPath}/updateMachine/${machineList.machinId}" ><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                             <a href="${pageContext.request.contextPath}/getAllActivities/${machineList.machinId}"><span
														class="glyphicon glyphicon-list"></span></a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/deletePmMachineById/${machineList.machinId}" 
