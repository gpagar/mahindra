...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search" title="Type in a name" style="border-radius: 23px;">
				...
				<div class="agile-tables">
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tr>
				                 <td><b>Activity:</b></td>
                              <td><b>${activity.activityName}</b></td>
                              ...
                              <td>${itemList.itemName}</td>
                               ...
                               <td>
                               <a href="${pageContext.request.contextPath}/updateItem/${itemList.itemId}" ><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                             <a href="${pageContext.request.contextPath}/getAllCheckpoints/${itemList.itemId}"><span
														class="glyphicon glyphicon-list"></span></a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/deletePmItemById/${itemList.itemId}" 
