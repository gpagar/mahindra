			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Checkpoint List
							</h3>
							<div class="box-tool">
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search" title="Type in a name" style="border-radius: 23px;">
				...
				<div class="agile-tables">
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tr>
				              ...
				              <c:forEach items="${checkpointList}" var="checkpointList" varStatus="count">
				               <tr>
				                 <td>${count.index+1}</td>
                              <td>${checkpointList.checkPointName}</td>
                            
                             
                               <td>
                               <a href="${pageContext.request.contextPath}/updateCheckpoint/${checkpointList.checkPointId}" ><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/deletePmCheckpointById/${checkpointList.checkPointId}" 
			...
			<div class="col-sm-3 col-lg-3 controls">
						<a href="${pageContext.request.contextPath}/showAddCheckpoint">
						<input type='button'  class="btn btn-primary" value="Add Checkpoint"/>					</a>
						</div>		     
				</div>
