					...
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tbody>
				             ...
				             <td>${typeName}</td> 
				              		 ...
				              		 <td > <a href="${pageContext.request.contextPath}/editUser/${list.userId}"><input type="button"  class="btn btn-primary" value="Edit"   /></a>&nbsp;&nbsp;
				              		 <a href="${pageContext.request.contextPath}/deleteUser/${list.userId}"><input type="button"  class="btn btn-primary" value="Delete"   /></a></td>
