			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>TBM Machine Item List
							</h3>
							<div class="box-tool">
					...
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tbody>
						 <%-- <tr>
				              ...
				              <c:forEach items="${tbmMachineItemList}" var="tbmMachineItemList" varStatus="count">
				               <tr>
				                 <td>${count.index+1}</td>
                              <td>${tbmMachineItemList.itemName}</td>
                            
                             <td>${tbmMachineItemList.frequency}</td>  
                               <td>
                               <a href="${pageContext.request.contextPath}/updateTbmItemById/${tbmMachineItemList.itemId}" ><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                             
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/deleteTbmItemById/${tbmMachineItemList.itemId}" 
