			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>Machine List
							</h3>
							<div class="box-tool">
					...
					<div class="w3l-table-info" style="overflow-x:auto; height:400px">
						...
						<tbody>
						 <%-- <tr>
				              ...
				              <c:forEach items="${tbmMachineDetailsList}" var="tbmMachineDetailsList" varStatus="count">
				               <tr>
				                 <td>${count.index+1}</td>
                              <td>${tbmMachineDetailsList.machineName}</td>
                            
                              <td>${tbmMachineDetailsList.machineNo}</td>
                               <td>
                               <a href="${pageContext.request.contextPath}/updateMAchine/${tbmMachineDetailsList.machineId}" ><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                             <a href="${pageContext.request.contextPath}/showTbmLocationById/${tbmMachineDetailsList.machineId}"><span
														class="glyphicon glyphicon-list"></span></a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/deleteTbmMachineById/${tbmMachineDetailsList.machineId}" 
