...
<!--four-grids here-->
  ...
  <div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/showTbmSchedule">	<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
							<h5><b>TBM Schedule</b></h5>
					...
					<div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/showTbm">	<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
					...
					<div class="col-md-2 four-grid">
						<a href="${pageContext.request.contextPath}/showAddTbmMachine"><div class="four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
							<h5><b>Add TBM Machine</b></h5>
						</div>
