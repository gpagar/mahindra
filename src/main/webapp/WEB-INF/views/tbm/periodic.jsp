...
<!--four-grids here-->
  ...
  <div class="four-grids"id="dept1">
   <div class="row" >
  <div class="col-md-1"></div>  <div class="col-md-1"></div>  <div class="col-md-1"></div>  <div class="col-md-1"></div> 
 
					<div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/showTbmMenu">	<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
					...
					<div class="col-md-2 four-grid">
						<a href=""><div class="four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
