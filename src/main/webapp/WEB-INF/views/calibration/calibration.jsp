...
<jsp:include page="/WEB-INF/views/include/header.jsp"></jsp:include>
 ...
 <c:url var="importExcelCal" value="/importExcelCal"></c:url>
				...
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/importExcelCal"  class="form-horizontal"
							 id="validation-form"
										enctype="multipart/form-data" method="post">
							

						<div class="form-group">
									<label class="col-sm-3 col-lg-4 control-label">EXCEL FILE</label>
									<div class="col-sm-6 col-lg-4 controls">
										<input type="file" name="file" id="file"  class="form-control"  data-rule-required="true" />
									</div>
