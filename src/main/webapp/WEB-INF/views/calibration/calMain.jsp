...
<!--four-grids here-->
  ...
  <div class="col-md-1"></div>  <div class="col-md-1"></div>  <div class="col-md-1"></div> 
 	<div class="col-md-2 four-grid">
						<a href="${pageContext.request.contextPath}/showCalibration"><div class="four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
							<h5><b>Calibration</b></h5>
						</div>
					...
					<div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/showEqCal">	<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
							<h5><b>Add Equip/Instrument</b></h5>
							</div>
							
						</div></a>
					</div>
					<div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/editEqCal">	<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
							<h5><b>Edit Equip/Instrument</b></h5>
							</div>
