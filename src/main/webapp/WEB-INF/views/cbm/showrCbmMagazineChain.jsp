			...
			<div class="row">
					...
					<div class="box">
						<div class="box-title"><br>
							<div class="col-md-7" style="font-size: 23px">
								<i class="fa fa-bars"></i>  Magazine chain  Check sheet
							 	...
							 	<a href="${pageContext.request.contextPath}/showCbmMagazineChainHistory">	<button type="button" class="btn btn-success" >Spindle Clamping Force History</button> </a> 
								 
						</div>			
							<div class="box-tool">
						
						</div>
						<form action="${pageContext.request.contextPath}/submitCbmMagazineChain"  class="form-horizontal"
				...
				<div class="agile-tables">
					<div class="w3l-table-info" style="overflow-x:auto; height:450px">
						...
						<thead>
						  ...
						  <!-- <tr>
						   ...
						   <tr>
							...
							<th colspan="3"  style="text-align: center;">Mahindra & Mahindra Ltd, Igatpuri Plant<br>Magazine chain  Check sheet
							</th> 
							<th colspan="2"  style="text-align: center;">Month : ${monthName1} &nbsp; <input type="date" style="color: black;" value="${date1}" name="date1" id="date1" required/>
							</th> 
							<th colspan="2"  style="text-align: center;">Month : ${monthName2} &nbsp; <input type="date" style="color: black;" value="${date2}" name="date2" id="date2" required/>
							</th> 
						  </tr>  
						...
						<tbody>
				              <c:forEach items="${cbmMagazineChainList}" var="cbmMagazineChainList" varStatus="count">
				               <tr>
				                 <td>${count.index+1}</td>
				                  <td>${cbmMagazineChainList.machineNo}</td> 
				                    
				                     <td><input type="text" class="form-control" value="${cbmMagazineChainList.requiredValue}" name="requiredValue${cbmMagazineChainList.schId}" id="requiredValue${cbmMagazineChainList.schId}"  /></td>
				                      <td  ><input type="text" class="form-control" value="${cbmMagazineChainList.actualValue1}" name="actualValue1${cbmMagazineChainList.schId}" id="actualValue1${cbmMagazineChainList.schId}"  /> </td>
				                       <td><input type="text" class="form-control" value="${cbmMagazineChainList.remark1}" name="remark1${cbmMagazineChainList.schId}" id="remark1${cbmMagazineChainList.schId}"  /></td>
				                        <td  ><input type="text" class="form-control" value="${cbmMagazineChainList.actualValue2}" name="actualValue2${cbmMagazineChainList.schId}" id="actualValue2${cbmMagazineChainList.schId}"  /></td>
				                        <td  ><input type="text" class="form-control" value="${cbmMagazineChainList.remark2}" name="remark2${cbmMagazineChainList.schId}" id="remark2${cbmMagazineChainList.schId}"  /> </td>
				                       </tr>
                              </c:forEach>
							</tbody>
					  </table>
				...
				<form action="${pageContext.request.contextPath}/yearEndMagazinechain"  class="form-horizontal"
