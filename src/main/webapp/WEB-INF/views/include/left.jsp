					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
								...
								<li><a href="showPmPlan"><i class="fa fa-history" aria-hidden="true"></i><span>Machine History </span><div class="clearfix"></div></a></li>
									 
									
									<li><a href="showPmPlan"><i class="fa fa-h-square" aria-hidden="true"></i><span>History Card</span><div class="clearfix"></div></a></li>
								...
								<li><a href="showPmPlan"><i class="	fa fa-internet-explorer" aria-hidden="true"></i><span>Mail Alerts</span><div class="clearfix"></div></a></li>
									...
									<li><a href="showPmPlan"><i class="fa fa-calendar" aria-hidden="true"></i><span>Schedulers</span><div class="clearfix"></div></a></li>
									 ...
									 <li id="menu-academico" ><a href="history"><i class="fa fa-bar-chart"></i><span>Auto Graph Plotting </span><div class="clearfix"></div></a></li>
