...
<table width="100%" border="0"  cellpadding="0" cellspacing="0" style="border-left:1px solid #313131;border-right:1px solid #313131;border-top:1px solid #313131;overflow-x:scroll;overflow-y:hidden;">
 ...
 <tr  bgcolor="pink">
    ...
    <td width="33%" colspan="4" style="border-top:1px solid #313131;padding:2px;color:#FFF; ">
...
Workstation Name : ${whyWhyF18.machineName}</p> 
 ...
 <td width="20%" colspan="2" style="border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
    ...
    <td width="20%" colspan="2" style="border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
     ...
     <td width="20%" colspan="3" style="border-top:1px solid #313131; padding:2px;color:#FFF; ">
 ...
 <td width="50%" colspan="5" style="border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
    ...
    <td width="50%" colspan="5" style="border-top:1px solid #313131;padding:2px;color:#FFF; ">
     <p style="color:#000; font-size:12px; text-align:left;margin:5px;">Previous Occurrence Date : ${whyWhyF18.prevOccDate}</p> 
    </td>
 ...
 <td width="20%" colspan="2" style="text-align:right;   border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
    ...
    <td width="80%" colspan="9" style="border-top:1px solid #313131;padding:2px;color:#FFF; ">
...
(Action for restaring MC)</b></p> 
 ...
 <td width="30%" colspan="2" style="text-align:right;   border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
    ...
    <input type="checkbox"  checked="checked"/></c:if></b></p> 
    </td>
 ...
 <td width="20%" colspan="2" style="text-align:right;   border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
    ...
    <td width="40%" colspan="4" style="border-top:1px solid #313131;border-right:1px solid #313131;padding:2px;color:#FFF; ">
     <p style="color:#000; font-size:12px; text-align:left;margin:5px;">PU Manager / Department Head : ${whyWhyF18.mgrorhead}</p> 
    </td>
     <td width="30%" colspan="4" style="border-top:1px solid #313131;padding:2px;color:#FFF; ">
   ...
   <input type="checkbox" name="systemclassif" value="1"/> 1.Mechanical<br></br>
    ...
    <input type="checkbox" name="systemclassif" value="8"/>8.Heating
     ...
     <p style="color:#000; font-size:12px; text-align:left;margin:5px;">Breakdown Phenomenon</p> 
      ...
      <td width="20%" colspan="2" style="border-top:1px solid #313131;padding:2px;color:#FFF; border-bottom:1px solid #313131;">
     <p style="color:#000; font-size:12px; text-align:left;margin:5px;">
    <c:choose>
 ...
 <input type="checkbox" name="breakdownPhenomenon" value="8"/>8.Cracked etc.</p> 
   ...
   <%--      <div class="row" align="center">
						<div class="col-sm-9 col-sm-offset-3 col-lg-8 col-lg-offset-2">
		                    ...
		                    <a href="${pageContext.request.contextPath}/showWhyWhyf18"><button  class="btn btn-info">GO BACK</button></a>
