   ...
   <c:url var="searchBrekTimeGraphData" value="/searchBrekTimeGraphData"></c:url> 
			...
			<div class="row">
				<div class="col-md-12">
                      <div class="row">
							<h3>
								<i class="fa fa-bars"></i> BREAKDOWN MONITORING TREND &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span style="text-align:right;">
							<a href="${pageContext.request.contextPath}/showTargetG4" >	<i class="glyphicon glyphicon-plus"></i>Target</a></span>
							</h3>
						</div>
			                <input type="hidden" id="graphType" name="graphType" value="4"/>
...
<script type="text/javascript">
	...
	function searchGraph()
	{
		...
		var firstYear=parseFloat(data.yearlyMachineBdTimeList.breakdownYearly.firstYearTime/60);  firstYear=parseFloat(firstYear.toFixed(1));
	    var secondYear=parseFloat(data.yearlyMachineBdTimeList.breakdownYearly.secondYearTime/60);secondYear=parseFloat(secondYear.toFixed(1));
	    var thirdYear=parseFloat(data.yearlyMachineBdTimeList.breakdownYearly.thirdYearTime/60);thirdYear=parseFloat(thirdYear.toFixed(1));
	    var fourthYear=parseFloat(data.yearlyMachineBdTimeList.breakdownYearly.fourthYearTime/60);fourthYear=parseFloat(fourthYear.toFixed(1));
       ...
       var  avgL3Targetpm=parseFloat(year4L3Target/12);avgL3Targetpm=parseFloat(avgL3Targetpm.toFixed(1));
    	...
    	var day1=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day1/60);day1=parseFloat(day1.toFixed(1));
    	var day2=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day2/60);day2=parseFloat(day2.toFixed(1));
    	var day3=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day3/60);day3=parseFloat(day3.toFixed(1));
    	var day4=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day4/60);day4=parseFloat(day4.toFixed(1));
    	var day5=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day5/60);day5=parseFloat(day5.toFixed(1));
    	var day6=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day6/60);day6=parseFloat(day6.toFixed(1));
    	var day7=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day7/60);day7=parseFloat(day7.toFixed(1));
    	var day8=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day8/60);day8=parseFloat(day8.toFixed(1));
    	var day9=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day9/60);day9=parseFloat(day9.toFixed(1));
    	var day10=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day10/60);day10=parseFloat(day10.toFixed(1));
    	var day11=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day11/60);day11=parseFloat(day11.toFixed(1));
    	var day12=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day12/60);day12=parseFloat(day12.toFixed(1));
    	var day13=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day13/60);day13=parseFloat(day13.toFixed(1));
    	var day14=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day14/60);day14=parseFloat(day14.toFixed(1));
    	var day15=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day15/60);day15=parseFloat(day15.toFixed(1));
    	var day16=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day16/60);day16=parseFloat(day16.toFixed(1));
    	var day17=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day17/60);day17=parseFloat(day17.toFixed(1));
    	var day18=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day18/60);day18=parseFloat(day18.toFixed(1));
    	var day19=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day19/60);day19=parseFloat(day19.toFixed(1));
    	var day20=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day20/60);day20=parseFloat(day20.toFixed(1));
    	var day21=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day21/60);day21=parseFloat(day21.toFixed(1));
    	var day22=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day22/60);day22=parseFloat(day22.toFixed(1));
    	var day23=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day23/60);day23=parseFloat(day23.toFixed(1));
    	var day24=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day24/60);day24=parseFloat(day24.toFixed(1));
    	var day25=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day25/60);day25=parseFloat(day25.toFixed(1));
    	var day26=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day26/60);day26=parseFloat(day26.toFixed(1));
    	var day27=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day27/60);day27=parseFloat(day27.toFixed(1));
    	var day28=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day28/60);day28=parseFloat(day28.toFixed(1));
    	var day29=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day29/60);day29=parseFloat(day29.toFixed(1));
    	var day30=parseFloat(data.yearlyMachineBdTimeList.dailyBreakdowns.day30/60);day30=parseFloat(day30.toFixed(1));
    	...
    	var day26bd="26 \n Actual: "+day26;var day27bd="27 \n Actual: "+day27;var day28bd="28 \n Actual: "+day28;var day29bd="29 \n Actual: "+day29;var day30bd="30 \n Actual: "+day30;
		    ...
		    var options = {
		      title : 'Yearly Trends (Avg. Hours/Year)',
		      vAxis: {title: 'Hours(Avg.)'},
		      hAxis: {title: 'YEAR  -->'},
		      seriesType: 'bars',
		      series: {
		          1: { type: 'line' },
		  ...
		  /*     var breakdownL5Target1=parseInt(data.breakdownMothwiseL5Target.breakdownCnt1);
		      ...
		      function drawVisualization1() {
			    ...
			    var options = {
			      title : 'Monthly Trends (Hours/Month )',
			      vAxis: {title: 'Hours'},
			      hAxis: {title: 'Month  -->'},
			      seriesType: 'bars',
			      series: {
		      ...
		      function drawVisualization2() {
		    	...
		    	var options = {
		    	    		...
		    	    		curveType: 'function',
		    	        title: 'Daily Breakdown Monitoring trends Hrs/day(cum)',
		    	        hAxis: {
		    	            title: 'day',
		    	            titleTextStyle: {
		    	                color: '#333'
	...
	function showDailyGraph()
	{
		...
		$.getJSON('${searchBrekDailyTimeGraph}',{
			month : month,
			ajax : 'true',
		},
		function(data) {
			var avgL3Targetpm=parseFloat(data.dSearchedTarget.yearL3target/12);avgL3Targetpm=parseFloat(avgL3Targetpm.toFixed(1));
			 ...
			 google.charts.load('current', {'packages':['corechart']});
		      ...
		      google.charts.setOnLoadCallback(drawVisualization2);
		      var day1=parseFloat(data.dailyBreakdowns.day1/60);day1=parseFloat(day1.toFixed(1));
		    	var day2=parseFloat(data.dailyBreakdowns.day2/60);day2=parseFloat(day2.toFixed(1));
		    	var day3=parseFloat(data.dailyBreakdowns.day3/60);day3=parseFloat(day3.toFixed(1));
		    	var day4=parseFloat(data.dailyBreakdowns.day4/60);day4=parseFloat(day4.toFixed(1));
		    	var day5=parseFloat(data.dailyBreakdowns.day5/60);day5=parseFloat(day5.toFixed(1));
		    	var day6=parseFloat(data.dailyBreakdowns.day6/60);day6=parseFloat(day6.toFixed(1));
		    	var day7=parseFloat(data.dailyBreakdowns.day7/60);day7=parseFloat(day7.toFixed(1));
		    	var day8=parseFloat(data.dailyBreakdowns.day8/60);day8=parseFloat(day8.toFixed(1));
		    	var day9=parseFloat(data.dailyBreakdowns.day9/60);day9=parseFloat(day9.toFixed(1));
		    	var day10=parseFloat(data.dailyBreakdowns.day10/60);day10=parseFloat(day10.toFixed(1));
		    	var day11=parseFloat(data.dailyBreakdowns.day11/60);day11=parseFloat(day11.toFixed(1));
		    	var day12=parseFloat(data.dailyBreakdowns.day12/60);day12=parseFloat(day12.toFixed(1));
		    	var day13=parseFloat(data.dailyBreakdowns.day13/60);day13=parseFloat(day13.toFixed(1));
		    	var day14=parseFloat(data.dailyBreakdowns.day14/60);day14=parseFloat(day14.toFixed(1));
		    	var day15=parseFloat(data.dailyBreakdowns.day15/60);day15=parseFloat(day15.toFixed(1));
		    	var day16=parseFloat(data.dailyBreakdowns.day16/60);day16=parseFloat(day16.toFixed(1));
		    	var day17=parseFloat(data.dailyBreakdowns.day17/60);day17=parseFloat(day17.toFixed(1));
		    	var day18=parseFloat(data.dailyBreakdowns.day18/60);day18=parseFloat(day18.toFixed(1));
		    	var day19=parseFloat(data.dailyBreakdowns.day19/60);day19=parseFloat(day19.toFixed(1));
		    	var day20=parseFloat(data.dailyBreakdowns.day20/60);day20=parseFloat(day20.toFixed(1));
		    	var day21=parseFloat(data.dailyBreakdowns.day21/60);day21=parseFloat(day21.toFixed(1));
		    	var day22=parseFloat(data.dailyBreakdowns.day22/60);day22=parseFloat(day22.toFixed(1));
		    	var day23=parseFloat(data.dailyBreakdowns.day23/60);day23=parseFloat(day23.toFixed(1));
		    	var day24=parseFloat(data.dailyBreakdowns.day24/60);day24=parseFloat(day24.toFixed(1));
		    	var day25=parseFloat(data.dailyBreakdowns.day25/60);day25=parseFloat(day25.toFixed(1));
		    	var day26=parseFloat(data.dailyBreakdowns.day26/60);day26=parseFloat(day26.toFixed(1));
		    	var day27=parseFloat(data.dailyBreakdowns.day27/60);day27=parseFloat(day27.toFixed(1));
		    	var day28=parseFloat(data.dailyBreakdowns.day28/60);day28=parseFloat(day28.toFixed(1));
		    	var day29=parseFloat(data.dailyBreakdowns.day29/60);day29=parseFloat(day29.toFixed(1));
		    	var day30=parseFloat(data.dailyBreakdowns.day30/60);day30=parseFloat(day30.toFixed(1));
