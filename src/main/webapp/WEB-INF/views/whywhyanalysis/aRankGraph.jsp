    	...
    	/* 	  for(var i=0;i<data.breakdownYearlyListRes.bProblemsList.list1.length;i++)
		      ...
		      function drawVisualization() {
		        ...
		        var data = google.visualization.arrayToDataTable([
		         ...
		         ['F-'+(year-3)+'',firstYear,firstYear+'',avgYear1L3Targetpm,avgYear1L3Targetpm,false,avgYear1L5Targetpm,avgYear1L5Targetpm],
		         ['F-'+(year-2)+'', secondYear,secondYear+'',avgYear2L3Targetpm,avgYear2L3Targetpm,false,avgYear2L5Targetpm,avgYear2L5Targetpm],
		         ['F-'+(year-1)+'',  thirdYear,thirdYear+'',avgYear3L3Targetpm,avgYear3L3Targetpm,false,avgYear3L5Targetpm,avgYear3L5Targetpm],
		         ['F-'+year+'', fourthYear,fourthYear+'',avgL3Targetpm,avgL3Targetpm,false,avgL5Targetpm,avgL5Targetpm],
			 ...
			 google.charts.load('current', {'packages':['corechart']});
			  ...
			  function drawVisualization2() {
		    	...
		    	data.addRows([
		    	  ...
		    	  [{v: 31, f:'31'},0, avgL3Targetpm, false,avgL5Targetpm]
		    	]);
		    	var options = {
