...
<c:url var="searchCalibrationScheduleGraphData" value="/searchCalibrationScheduleGraphData" />
<c:url var="updateGraphOwner" value="/updateGraphOwner" />
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row">
							<h3>
							&nbsp;&nbsp;	<i class="fa fa-bars"></i> Calibration Schedule Adherance &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span style="text-align:right;">
							<a href="${pageContext.request.contextPath}/showTargetG11" >	<i class="glyphicon glyphicon-plus"></i>Target</a></span>
							</h3>
						</div>
				     ...
				     <td width="15%" style="background:#f9eb3f; "><b>${sessionScope.deptName}</b></td>
				      <td width="55%"style="text-align: center;background:#f9eb3f;"><b>Calibration Schedule Adherance</b></td>
...
<script type="text/javascript">
	...
	function searchGraph()
	{
		...
		$.getJSON('${searchCalibrationScheduleGraphData}',{
       ...
       var aprTarget=parseInt(data.pmTargetGData.aprTarget);
	      ...
	      var totalYearTarget=aprTarget+mayTarget+juneTarget+julyTarget+augTarget+septTarget+octTarget+novTarget+decTarget+janTarget+febTarget+marchTarget;
		    ...
		    var options = {
		      title : 'Yearly Trends (Calibration Schedule adherance) ',
		      vAxis: {title: 'No. of points.'},
		      hAxis: {title: 'YEAR  -->'},
		      seriesType: 'bars',
		      series: {
		          1: { type: 'line' },
		    ...
		    chart.draw(data, options);
		     $('#loading1').hide();
		      ...
		      function drawVisualization1() {
			    ...
			    var options = {
			      title : 'Monthly Trends (Calibration Schedule adherance) ',
