...
<c:url var="searchAllBrekGraphData" value="/searchAllBrekGraphData" />
<c:url var="updateGraphOwner" value="/updateGraphOwner" />
 ...
 <c:url var="importExcel2" value="/importExcel2"></c:url>
   ...
   <c:url var="searchAllBrekDailyGraph" value="/searchAllBrekDailyGraph"></c:url> 
			...
			<div class="row">
				<div class="col-md-12">
                      <div class="row">
							<h3>
								<i class="fa fa-bars"></i> All  Machines Breakdown Incidences &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span style="text-align:right;">
							<a href="${pageContext.request.contextPath}/showTargetG3" >	<i class="glyphicon glyphicon-plus"></i>Target</a></span>
							</h3>
						</div>
				     ...
				     <td width="15%" style="background:#f9eb3f; "><b>${sessionScope.deptName}</b></td>
				      <td width="55%"style="text-align: center;background:#f9eb3f;"><b>All  Machines Breakdown Incidences</b></td>
...
<br><br><br><br><br><br><br></div> </center>
				    </div>				      <img src="${pageContext.request.contextPath}/resources/home/images/down.jpg" width="35" height="42">
...
<script type="text/javascript">
	...
	function searchGraph()
	{
       ...
       var d = new Date();
		...
		$.getJSON('${searchAllBrekGraphData}',{
		...
		var firstYear=parseInt(data.breakdownYearlyListRes.breakdownYearly.firstYear/12); 
	    var secondYear=parseInt(data.breakdownYearlyListRes.breakdownYearly.secondYear/12);
	    var thirdYear=parseInt(data.breakdownYearlyListRes.breakdownYearly.thirdYear/12);
       ...
       // var avgL3Targetpd=parseInt(year4L3Target/30);
    	...
    	var day26bd="26 \n Actual: "+day26;var day27bd="27 \n Actual: "+day27;var day28bd="28 \n Actual: "+day28;var day29bd="29 \n Actual: "+day29;var day30bd="30 \n Actual: "+day30;
		    ...
		    var options = {
		      title : 'Yearly Trends (Avg. No of  Incidences/Annum )',
	...
	function showDailyGraph()
	{
		...
		$.getJSON('${searchAllBrekDailyGraph}',{
			month : month,
			ajax : 'true',
		},
		function(data) {
