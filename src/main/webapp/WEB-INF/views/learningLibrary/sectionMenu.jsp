...
<title>Learning Library Section</title>
...
<!--four-grids here-->
  ...
  <div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/addFile/1">	<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
					...
					<div class="col-md-2 four-grid">
					<a href="${pageContext.request.contextPath}/addFile/2">	<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
					...
					<div class="col-md-2 four-grid">
						<a href="${pageContext.request.contextPath}/addFile/3"><div class="four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text" style="color:white;">
